...
# t-test. This test is used to find if a statistically significant exists between two different groups. 
# Maternal DNMs and Paternal DNMs are different groups, and we want to know the difference of these two groups
